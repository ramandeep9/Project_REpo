    ...
    <div className="profile-us-container">
      ...
      <div className="profile-form-container">
        <form className="profile-form">
          ...
          <h3 className="nm2">Name</h3>
            <input type="text" className="inputt" id="name1" name="name" placeholder="Your Name" required />
          </div>
          <div className="profileform-group">
          <h3 className="nm2">Email</h3>
            <input className="inputt" type="email_L" id="email1" name="email" placeholder="Your Email" required />
          </div>
          <div className="profileform-group">
          <h3 className="nm2">Mobile No.</h3>
            <input className="inputt" type="tel" id="mobile1" name="mobile" placeholder="Your Mobile Number" required />
          </div>
          <div className="profileform-group">
          <h3 className="nm2">Highest Qualification</h3>
          <div>
      
         <select id="dropdown1" value={selectedOption} onChange={handleChange} className="inputt" >
       ...
       <h3 className="nm2">Language Proficiency</h3>
          <div>
     <select id="dropdown1" value={selectedOptions} onChange={handleChanges} className="inputt" >
